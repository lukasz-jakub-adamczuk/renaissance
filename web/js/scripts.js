// var host = 'http://localhost/~ash/renaissance/pub';
var host = 'http://ash.unixstorm.org/renaissance/pub';

var getShouts = function(timestamp) {
	$.getJSON(host + '/shoutbox/get/timestamp/' + timestamp, function(data) {
		var items = [];
		$.each(data, function(idx, itm) {
			// console.log(itm);
			items.push('<li>'
				+ '<img class="author-on-left" src="' + host + '/imgs/site/red/' + itm.slug + '.png" width="50" height="50">'
				+ '<span>' + itm.name + '</span>'
...
$(document).ready(function() {
	...
	if (window.location.href == host + '/shoutbox') {
