...
class FrontController extends Controller {
	...
	public function runBeforeMethod() {
		...
		// title
		$this->_oRenderer->assign('sTitle', 'Squarezone - '.ValueMapper::getName($this->getCtrlName()));
		...
		$this->_oRenderer->assign('aNavTop', $aNavTop);

		// print_r($_SERVER);
		// echo [REDIRECT_URL] => uzytkownicy/ashley-riot
		$sSelfUrl = str_replace('/~ash/renaissance/pub/', '', $_SERVER['REDIRECT_URL']);
		$this->_oRenderer->assign('self', $sSelfUrl);
		...
		$this->_oRenderer->assign('aResources', $aResources);
		...
		$this->_oRenderer->assign('aCosplays', $aCosplays);
		...
		$this->_oRenderer->assign('aWallpapers', $aWallpapers);
		...
		$this->_oRenderer->assign('aFanarts', $aFanarts);
