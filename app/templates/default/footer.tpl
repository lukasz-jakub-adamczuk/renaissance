        <footer id="footer" class="theme">
            ...
            <div class="footer-items">
                ...
                </div><div class="front-item col-4">
                    <h3>Społeczność</h3>
                    <ul class="clean">
            ...
            {*<div class="inner border-top v-padding clearfix">
                ...
                &middot; <a href="https://validator.w3.org/nu/?doc=http%3A%2F%2Fsquarezone.pl%2F" class="icon-html" title="Nu Html Checker"></a> &middot; <a href="https://validator.w3.org/unicorn/check?ucn_uri=squarezone.pl&warning=1&usermedium=all&ucn_lang=pl&ucn_task=full-css#" class="icon-css" title="Unicorn"></a> <a href=
                https://github.com/lukasz-jakub-adamczuk/renaissance#renaissance" class="icon-github"></a>
                </p>
                <p class="small left">
