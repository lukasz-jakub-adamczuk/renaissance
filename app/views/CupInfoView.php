...
class CupInfoView extends View {
	...
	public function fill() {
		...
		if ($aObject) {
			...
			// title
			$this->_oRenderer->assign('sTitle', 'Squarezone - Mistrzostwa - '.$sCategoryName.' - '.$oEntity->getField('name'));
			...
			$this->_oRenderer->assign('aPlayer', $aObject);
			// $this->_oRenderer->assign('aNavigator', $oEntity->getNavigator());
		} else {
			// log 404
